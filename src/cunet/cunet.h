...
struct CUNet2dImpl : torch::nn::Module {
    CUNet2dImpl(int32_t inChannels, int32_t outChannels, int32_t featureChannels=64, int32_t levels=5, int32_t kernelSize=3, bool padding=true, bool convolutionDownsampling=true, bool convolutionUpsampling=true, bool partialConvolution=true, bool batchNorm=true, bool showSizes=false)
    {
        this->levels=levels;
       ...
       // std::cout << "L44: " << inChannels << " " << outChannels << " " << featureChannels << " " << levels << std::endl; //, got 3,21,16,4 previously with initNeurons = 16
        ...
        if (sigmoid){
            std::cout << "using sigmoid output" << std::endl;
        }
        std::cout << "Initialized CUNET" << std::endl;
    }
...
struct CUNet1dImpl : torch::nn::Module {
    CUNet1dImpl(int32_t inChannels, int32_t outChannels, int32_t featureChannels=24, int32_t levels=12, int32_t kernelSize=5, bool padding=true, bool convolutionDownsampling=true, bool convolutionUpsampling=true, bool partialConvolution=true, bool batchNorm=false, bool showSizes=false)
    {
        ...
        // std::cout << "added sigmoid L265 cunet.h" << std::endl;
    ...
    torch::Tensor forward(const torch::Tensor& inputTensor) {
        ...
        // // my addition
        // outputTensor = sigmoid->forward(outputTensor);
